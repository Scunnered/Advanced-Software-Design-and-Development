...
public class MainApp {
    public static void main(String[] args)
    {
        ...
        System.out.println(d1.compareTo(d2));  //should output 0
        System.out.println(d2.compareTo(d3));  //should output -1
        ...
        //Test for TimedAppointment class
